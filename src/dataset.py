...
def _build_input_ids(branch_texts: list[str], target_text: str, tokenizer, max_len: int) -> list[int]:
    """Construct token IDs for a branch + target input.
    ...
    # Build the final token sequence.
    ids = [cls_id]
    ...
    return ids[:max_len]  # safety clamp
